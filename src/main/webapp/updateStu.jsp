...
<div class="container">
    ...
    <form action="StudentServlet" method="post">
        ...
        <p>
            ...
            <%-- 显示当前姓名，允许修改 --%>
            <input type="text" id="stuName" name="stuName" value="${student.stuName}" required>
        </p>

        <p>
            <label for="stuAge">年龄:</label>
            <%-- 显示当前年龄，允许修改 --%>
            <input type="number" id="stuAge" name="stuAge" value="${student.stuAge}" required min="15" max="60">
        </p>
