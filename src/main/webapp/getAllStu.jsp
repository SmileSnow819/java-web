    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="mb-6 flex flex-wrap gap-4">
        <c:url var="addStuUrl" value="addStu.jsp">
          <c:param name="returnView" value="getAll" />
        ...
        <a
          href="${addStuUrl}"
          class="inline-flex items-center px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
        >
          <svg
            class="w-5 h-5 mr-2"
            fill="none"
        ...
        <a
          ...
          class="inline-flex items-center px-6 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-all shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
        >
          <svg
            class="w-5 h-5 mr-2"
            fill="none"
      ...
      <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        >
          ...
          <div class="flex gap-2">
            ...
            <a
              href="StudentServlet?action=getAll"
              class="px-6 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600 transition-colors shadow-md"
            >
              重置
            </a>
          </div>
    ...
    <script>
      ...
      function confirmDelete(stuNo) {
        if (confirm('是否确认开除学生学号 ' + stuNo + ' ？此操作不可逆！')) {
          var url =
            'StudentServlet?action=delStu&returnView=getAll&stuNo=' + stuNo;
          var searchStuNo = document.getElementById('searchStuNo')
            ? document.getElementById('searchStuNo').value
            : '';
          var searchStuName = document.getElementById('searchStuName')
          ...
          var searchEndAge = document.querySelector(
            'input[name="endAge"]'
          ).value;
          ...
          if (searchStartAge && searchStartAge.trim() !== '') {
            url += '&queryStartAge=' + encodeURIComponent(searchStartAge);
          }
          if (searchEndAge && searchEndAge.trim() !== '') {
            url += '&queryEndAge=' + encodeURIComponent(searchEndAge);
          }
